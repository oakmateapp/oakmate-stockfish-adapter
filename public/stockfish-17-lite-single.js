 ...
 */ !(function () {
    ...
    function o() {
        function e(e) {
            (e = e || {}),
                ((f = f || (void 0 !== e ? e : {})).ready = new Promise(
                    function (e, n) {
                        (T = e), (i = n);
                    }
                )),
            ...
            function J(e, n, t) {
                var r = n + t;
                for (t = n; e[t] && !(r <= t); ) ++t;
                if (16 < t - n && e.subarray && N)
                    return N.decode(e.subarray(n, t));
                for (r = ""; n < t; ) {
                    var o,
                        i,
                        a = e[n++];
            ...
            (f.preloadedImages = {}),
                ...
                (w = "stockfish.wasm"),
                re() ||
                    ((o = w), (w = f.locateFile ? f.locateFile(o, p) : p + o));
            var ae = [null, [], []],
                ue = {};
            function se(e) {
                if (!ne && !v)
            ...
            function pe() {
                if (!ce) {
                    ...
                    for (e in fe)
                        void 0 === fe[e] ? delete n[e] : (n[e] = fe[e]);
                    var t = [];
            ...
            function me(e, n, t, r) {
                ...
                var f,
                    ...
                    l = {
                        ...
                        "%I": function (e) {
                            return (
                                0 == (e = e.L) ? (e = 12) : 12 < e && (e -= 12),
                                i(e, 2)
                            );
                        },
                        "%j": function (e) {
                            return i(
                                e.K + de(A(e.I + 1900) ? I : R, e.J - 1),
                                3
                            );
                        },
                        "%m": function (e) {
                        ...
                        "%U": function (e) {
                            ...
                            return a(t, (e = new Date(e.I + 1900, e.J, e.K))) <
                                0
                                ? i(
                                      Math.ceil(
                                          (31 -
                ...
                for (c in ((t = t.replace(/%%/g, "\0\0")), l))
                    t.includes(c) &&
                        (t = t.replace(new RegExp(c, "g"), l[c](r)));
                return (
                    (t = t.replace(/\0\0/g, "%")),
                    (f = t),
                    (p = Array(G(f) + 1)),
            ...
            var P,
                ...
                Ce =
                    ...
                    (f.___wasm_call_ctors = function () {
                        return (f.___wasm_call_ctors = f.asm.s).apply(
                            null,
                            arguments
                        );
                    }),
                ...
                De = (f.___errno_location = function () {
                    return (De = f.___errno_location = f.asm.w).apply(
                        null,
                        arguments
                    );
                }),
                ...
                Re = (f.stackRestore = function () {
                    return (Re = f.stackRestore = f.asm.A).apply(
                        null,
                        arguments
                    );
                }),
            ...
            if (
                ((f._asyncify_start_unwind = function () {
                    return (f._asyncify_start_unwind = f.asm.E).apply(
                        null,
                        arguments
                    );
                }),
                (f._asyncify_stop_unwind = function () {
                    return (f._asyncify_stop_unwind = f.asm.F).apply(
                        null,
                        arguments
                    );
                }),
                (f._asyncify_start_rewind = function () {
                    return (f._asyncify_start_rewind = f.asm.G).apply(
                        null,
                        arguments
                    );
                }),
                (f._asyncify_stop_rewind = function () {
                    return (f._asyncify_stop_rewind = f.asm.H).apply(
                        null,
                        arguments
                    );
                }),
                ...
                (function (n) {
                    return function (e) {
                        ++r,
                            (o[n] = e),
                            r === t &&
                                ((e = URL.createObjectURL(new Blob(o))), u(e));
                    };
                })(e)
            );
    }
              ...
              e
                  ...
                  : ((e = self.location.hash.substr(1).split(",")),
                    (a = decodeURIComponent(
                        e[0] ||
                            location.origin +
                                location.pathname.replace(/\.js$/i, ".wasm")
                    )),
                    (u = function (n) {
                        (t = {
                            locateFile: function (e) {
